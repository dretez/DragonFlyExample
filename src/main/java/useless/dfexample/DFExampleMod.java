...
public class DFExampleMod implements ClientStartEntrypoint, GameStartEntrypoint {
	...
	public static final Block sideTest = new BlockBuilder(MOD_ID)
		.setBlockModel(new BlockModelDragonFly(ModelHelper.getOrCreateBlockModel(MOD_ID, "block/direction_pyramid.json")))
		.build(new BlockModel("exampleSides", 1005, Material.dirt, ModelHelper.getOrCreateBlockModel(MOD_ID, "block/direction_pyramid.json")));
